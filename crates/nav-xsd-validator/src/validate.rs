...
fn walk_summary_normal(reader: &mut Reader<&[u8]>) -> Result<(), NavXsdValidationError> {
    ...
    // pre-0103 bug that bounced a correct multi-bucket body.
    ...
    loop {
        match read_event(reader)? {
            ...
            Event::End(_) => {
                ...
                // each in order. The pre-0103 validator hard-coded exactly one
...
<vatRateGrossData><vatRateGrossAmount>1050</vatRateGrossAmount><vatRateGrossAmountHUF>1050</vatRateGrossAmountHUF></vatRateGrossData>\
    ...
    /// The pre-0103 validator was built to the single-bucket shape and bounced
